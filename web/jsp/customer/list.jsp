                        ...
                        <FORM id="pageForm" name="pageForm"
                            ...
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    ...
                                    <input type="hidden" name="selected" value="<c:if test="${not empty parameters.selected}">true</c:if>">
